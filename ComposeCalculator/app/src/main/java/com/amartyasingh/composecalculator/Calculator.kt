...
import com.amartyasingh.composecalculator.ui.theme.LightGray
import com.amartyasingh.composecalculator.ui.theme.Orange
        ...
        Column(
            ...
            Row(
                ...
                CalculatorButton(
                    ...
                    modifier = Modifier
                        .aspectRatio(2f)
                        .weight(2f).background(LightGray),
                    onClick =  {
                ...
                CalculatorButton(
                    ...
                    modifier = Modifier
                        .aspectRatio(1f)
                        .weight(1f).background(LightGray),
            ...
            Row(
                ...
                CalculatorButton(
                    ...
                    modifier = Modifier
                        .aspectRatio(1f)
                        .weight(1f).background(Color.DarkGray),
                    onClick = {
            ...
            Row(
                ...
                CalculatorButton(
                    ...
                    modifier = Modifier
                        .aspectRatio(2f)
                        .weight(2f).background(Color.DarkGray),
                    onClick = {
